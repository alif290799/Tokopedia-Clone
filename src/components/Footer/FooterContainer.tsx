      ...
      <div className='flex justify-between items-start w-full px-32 mb-6 border-t-2 border-solid border-gray-300 p-7'>
        ...
        <div>
          ...
          <div className='flex justify-center items-center gap-1 w-fit mb-3'>
            <a href=""><img src={PCIDSS} alt="" className='w-20' /></a>
            <a href=""><img src={BSIISO} alt="" className='w-28' /></a>
            <a href=""><img src={BSIISO} alt="" className='w-28' /></a>
          </div>
          <div className='font-bold'>
            <h3 className='mb-2'>Ikuti Kami</h3>
            <div className='flex justify-center items-center gap-2 w-fit'>
              <a href=""><i className='bx bxl-facebook-circle text-blue-900 text-3xl'/></a>
              <a href=""><i className='bx bxl-twitter text-blue-400 text-3xl' /></a>
              <a href=""><i className='bx bxl-pinterest text-red-600 text-3xl' /></a>
              <a href=""><i className='bx bxl-instagram-alt text-pink-500 text-3xl' /></a>
            </div>
          </div>
        </div>
        <div>
